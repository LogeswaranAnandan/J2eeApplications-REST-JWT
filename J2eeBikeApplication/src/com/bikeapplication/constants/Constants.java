...
public class Constants {
	...
	public static final String VIEW_RENT_HISTORY = "select * from rentdetails inner join revenuedetails inner join bikedetails where revenuedetails.transactionid = rentdetails.transactionid AND bikedetails.bikeid = rentdetails.bikeid AND rentdetails.userid = ? order by rentdetails.transactionid desc";
